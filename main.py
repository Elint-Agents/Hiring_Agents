...
from utils.email_sender import send_second_round_emails
...
@app.post("/send-intern-mails")
def send_intern_emails(preview: bool = Query(False, description="Enable preview mode")):
    result = send_second_round_emails(preview)
    return {
